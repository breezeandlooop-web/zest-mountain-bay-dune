import { i as EMPTY_CHECKLIST, s as uid } from "./utils-BEOGomfO.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/factories-BppLBeFw.js
...
function blankMaterial() {
	return {
		...
		usableUnits: 1,
		reorderLevel: 0,
		lastPurchased: (/* @__PURE__ */ new Date()).toISOString().slice(0, 10),
		notes: ""
	};
}
...
function contentFromProduct(product) {
	...
	return {
		...
		assets: [
			{
				label: "Product photo",
				done: product.contentChecklist.productPhoto
			},
			{
				label: "Detail shot",
				done: product.contentChecklist.detailShot
			},
			{
				label: "Lifestyle shot",
				done: product.contentChecklist.lifestyleShot
			},
			{
				label: "Making video",
				done: product.contentChecklist.makingVideo
			},
			{
				label: "Caption",
				done: false
...
function localCaptionDraft(input) {
...
//#endregion
export { localCaptionDraft as a, contentFromProduct as i, blankMaterial as n, blankProduct as r, blankContent as t };
