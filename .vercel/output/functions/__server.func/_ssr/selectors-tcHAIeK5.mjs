import { n as parseISO, o as startOfMonth, r as isWithinInterval, s as endOfMonth, t as subMonths } from "../_libs/date-fns.mjs";
import { C as saleTrueCost, _ as inventoryValue, v as isLowStock } from "./router-D-9UDxAx.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/selectors-tcHAIeK5.js
function rangeFor(data, ref = /* @__PURE__ */ new Date()) {
	...
	if (data.period === "custom" && data.customFrom && data.customTo) return {
		start: parseISO(data.customFrom),
		end: parseISO(data.customTo)
	};
	return {
...
function moneySnapshot(data, ref = /* @__PURE__ */ new Date()) {
...
//#endregion
export { photographyGap as n, pulse as r, moneySnapshot as t };
