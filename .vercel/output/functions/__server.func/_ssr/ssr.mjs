...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-hk-qtxaw.mjs");
...
var manifest = { "bf7aa4748e3177edfb40cc55c39e759bf491e6189d38e1ee26255c9a83dfc5de": {
	functionName: "generateContentDraft_createServerFn_handler",
	importer: () => import("./generate-draft-9BkvTIDb.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-D-9UDxAx.mjs").then((n) => n.t),
